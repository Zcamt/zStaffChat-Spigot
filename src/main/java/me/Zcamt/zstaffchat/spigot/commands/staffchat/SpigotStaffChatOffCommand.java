...
public class SpigotStaffChatOffCommand extends BaseCommand {
    ...
    public SpigotStaffChatOffCommand(SpigotChatManager spigotChatManager) {
    ...
    public void onCommand(Player player, String[] args){
        ...
        if(args.length != 0){
            SpigotUtilities.sendMessage(player, SpigotConfigManager.staffchatPrefix + "&r &7Usage: /scoff");
            return;
        }
