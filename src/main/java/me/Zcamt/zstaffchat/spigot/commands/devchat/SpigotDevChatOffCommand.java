...
public class SpigotDevChatOffCommand extends BaseCommand {
    ...
    public SpigotDevChatOffCommand(SpigotChatManager spigotChatManager) {
    ...
    public void onCommand(Player player, String[] args){
        ...
        if(args.length != 0){
            SpigotUtilities.sendMessage(player, SpigotConfigManager.devchatPrefix + "&r &7Usage: /dcoff");
            return;
        }
