...
public class BungeeAdminChatOffCommand extends BaseCommand {
    ...
    public BungeeAdminChatOffCommand(BungeeChatManager bungeeChatManager) {
    ...
    public void onCommand(ProxiedPlayer player, String[] args){
        ...
        if(args.length != 0){
            BungeeUtilities.sendMessage(player, BungeeConfigManager.adminchatPrefix + "&r &7Usage: /acoff");
            return;
        }
