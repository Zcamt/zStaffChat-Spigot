...
@CommandAlias("devchatoff|dcoff")
public class BungeeDevChatOffCommand extends BaseCommand {
    ...
    public BungeeDevChatOffCommand(BungeeChatManager bungeeChatManager) {
    ...
    public void onCommand(ProxiedPlayer player, String[] args){
        ...
        if(args.length != 0){
            BungeeUtilities.sendMessage(player, BungeeConfigManager.devchatPrefix + "&r &7Usage: /dcoff");
            return;
        }
