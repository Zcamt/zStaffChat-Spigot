...
public class DevChatOffCommand extends BaseCommand {
    ...
    public DevChatOffCommand(ChatManager chatManager) {
    ...
    public void onCommand(Player player, String[] args){
        ...
        if(args.length != 0){
            Utils.sendMessage(player, ConfigManager.devchatPrefix + "&r &7Usage: /dcoff");
            return;
        }
